...
struct UserLandingView: View {
    ...
    var body: some View {
        ...
        ItemList(primaryUser: $primaryUser, items: filteredItems, filterItemType: $filterItemType, filterItemStatus: $filterItemStatus)
    }
}
...
struct UserLandingView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        UserLandingView(primaryUser: .constant(userData.user), items: .constant(userData.items))
    }
}
